...
\cventry{Mar.~2018-Present}{Research Associate for Analytical Systems and Applications}{Clemson University, Watt Family Innovation Center}{Clemson, SC}{}{
  \begin{itemize}
    \item One funded project through SCDA ACRE CGP (\$100k). Two pending DoD proposals. One NSF AD proposal in progress.
    \item Facilitation of applications of IBM Watson to research projects spanning 13 CU departments.
    \item Active research collaborations with IBM, GHS, ICAR, and Ulbrich Manufacturing.
    \item Co-leader of two Creative Inquiry teams focusing on research applications of data analytics and visualization.
